...
<div class="lg:col-span-7 p-6 sm:p-10 lg:p-12 flex flex-col justify-between bg-white">
    <div>
        ...
        <!-- LOGIN FORM -->
        <form action="#" method="POST" onsubmit="event.preventDefault(); handleLoginSubmit();" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input 
                        ...
                        name="email" 
                        required 
                        placeholder="admin@namatoko.sewain.id" 
                        oninput="updateTenantPreview(this.value)"
                ...
                <div id="tenant-preview-pill" class="mt-2 text-[11px] font-mono text-slate-500 flex items-center gap-1.5 hidden">
                    <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                    <span>Terdeteksi Portal Tenant: <strong id="detected-subdomain" class="text-emerald-700 font-bold">namatoko.sewain.id</strong></span>
                </div>
            </div>
            ...
            <div>
                <div class="flex items-center justify-between mb-2">
                    ...
                    <a href="#" onclick="alert('Instruksi Reset Password telah disimulasikan ke email tenant Anda.')" class="text-xs font-semibold text-emerald-600 hover:text-emerald-700 hover:underline">
                        Lupa Kata Sandi?
                    </a>
                </div>
                <div class="relative">
