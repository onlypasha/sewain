...
<div id="tab-content-overview" class="admin-tab-pane space-y-6">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-slate-500 text-xs mt-0.5">Pantau pendapatan, ketersediaan unit sewa, dan antrean verifikasi secara realtime.</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white p-6 rounded-3xl border border-slate-200 shadow-xs space-y-4">
            <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                <div>
                    <h3 class="font-bold text-slate-900 text-base font-heading">Pemesanan Terbaru yang Membutuhkan Aksi</h3>
                    <p class="text-xs text-slate-500">Konfirmasi serah terima unit atau penerbitan PDF Perjanjian Sewa.</p>
                </div>
                <button onclick="switchAdminTab('bookings')" class="text-xs font-bold text-emerald-600 hover:underline">Lihat Semua &rarr;</button>
            </div>

            <div class="space-y-3">
                <!-- Order Item 1 -->
                <div class="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 flex flex-col sm:flex-row sm:items-center justify-between gap-3 hover:border-emerald-500 transition-all">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-xl bg-emerald-100 text-emerald-800 font-bold flex items-center justify-center text-xs">
                            #948
                        </div>
                        <div>
                            <div class="flex items-center gap-2">
                            ...
                            <div class="text-xs text-slate-500 mt-0.5">Penyewa: <strong>Budi Pratama</strong> (3 Hari) • <code class="text-slate-700 font-mono">12-15 Aug 2026</code></div>
                        </div>
                    </div>
                    <div class="flex items-center gap-2 shrink-0">
                        <button onclick="alert('PDF Kontrak Digital #SEW-94812 berhasil diterbitkan!');" class="btn btn-xs btn-outline border-slate-300 font-semibold text-slate-700">📄 PDF Kontrak</button>
                        <button onclick="alert('Serah terima barang dikonfirmasi! Notifikasi WA terkirim ke pelanggan.');" class="btn btn-xs btn-emerald btn-primary font-bold">Serahkan Unit</button>
                    </div>
                </div>
                ...
                <div class="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 flex flex-col sm:flex-row sm:items-center justify-between gap-3 hover:border-emerald-500 transition-all">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-xl bg-amber-100 text-amber-800 font-bold flex items-center justify-center text-xs">
                            #947
                        </div>
                        <div>
                            <div class="flex items-center gap-2">
                                <span class="font-bold text-slate-900 text-sm">Godox SL60W Lighting Studio Set</span>
                                <span class="badge badge-xs badge-warning font-mono font-bold text-slate-950">PERLU VERIFIKASI</span>
                            </div>
                            <div class="text-xs text-slate-500 mt-0.5">Penyewa: <strong>Siti Rahmawati</strong> (1 Hari) • <code class="text-slate-700 font-mono">12 Aug 2026</code></div>
                        </div>
                    </div>
                    <div class="flex items-center gap-2 shrink-0">
                        <button onclick="switchAdminTab('verifications')" class="btn btn-xs btn-warning font-bold text-slate-950">Verifikasi E-KTP</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-slate-900 text-white p-6 rounded-3xl border border-slate-800 shadow-lg flex flex-col justify-between">
            <div>
                <div class="flex items-center justify-between border-b border-slate-800 pb-3 mb-4">
                    <span class="text-xs font-mono text-emerald-400 font-bold uppercase tracking-wider">Status Otomatisasi Tenant</span>
