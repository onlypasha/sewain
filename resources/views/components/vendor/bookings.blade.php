...
<div id="tab-content-bookings" class="admin-tab-pane hidden space-y-6">
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-slate-500 text-xs mt-0.5">Kelola status sewa, serah terima unit, penerbitan PDF kontrak, dan pengembalian deposit.</p>
        </div>
    </div>
                ...
                <tbody class="divide-y divide-slate-100 font-medium">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td class="text-center">
                            <span class="badge badge-xs badge-success text-white font-mono mb-1">E-KTP VERIFIED</span><br>
                            <button onclick="alert('PDF Kontrak Sewa #SEW-94812 Diterbitkan dengan Tanda Tangan Digital.');" class="text-[10px] text-emerald-600 underline font-semibold">Lihat PDF</button>
                        </td>
                        <td class="text-center">
                            <span class="badge badge-sm badge-info text-white font-bold">Sedang Disewa</span>
                        </td>
                        <td class="text-right">
                            <button onclick="alert('Pengembalian Unit Dikonfirmasi! Deposit Rp 300.000 dikembalikan ke Budi Pratama.');" class="btn btn-xs btn-emerald btn-primary font-bold">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td class="text-right">
                            <button onclick="switchAdminTab('verifications')" class="btn btn-xs btn-warning font-bold text-slate-950">
                                Cek Foto E-KTP
                            </button>
                        </td>
                    </tr>
