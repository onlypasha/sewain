...
<div id="super-tab-content-subscriptions" class="superadmin-tab-pane hidden space-y-6">
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-extrabold text-slate-900 font-heading">Tagihan & Billing MRR Platform</h1>
            <p class="text-slate-500 text-xs mt-0.5">Rekapitulasi transaksi berlangganan SaaS tenant, pembayaran otomatis, dan invoice.</p>
        </div>
    </div>
            ...
            <table class="table w-full text-xs">
                ...
                <tbody class="divide-y divide-slate-100 font-medium">
                    <tr class="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td class="text-center"><span class="badge badge-sm badge-emerald text-emerald-800 bg-emerald-100 font-bold">PAID SETTLED</span></td>
                        <td class="text-right"><button onclick="alert('Unduh PDF Invoice #INV-2026-0801');" class="btn btn-xs btn-ghost text-indigo-600 font-bold">PDF Invoice</button></td>
                    </tr>
                    <tr class="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td class="text-center"><span class="badge badge-sm badge-emerald text-emerald-800 bg-emerald-100 font-bold">PAID SETTLED</span></td>
                        <td class="text-right"><button onclick="alert('Unduh PDF Invoice #INV-2026-0802');" class="btn btn-xs btn-ghost text-indigo-600 font-bold">PDF Invoice</button> summer</td>
                    </tr>
                </tbody>
            </table>
        </div>
