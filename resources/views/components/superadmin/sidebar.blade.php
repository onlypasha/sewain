...
<aside
    ...
    <div>
        ...
        <nav class="p-4 space-y-1 text-xs font-medium">
            ...
            <div class="text-[10px] font-mono font-bold uppercase tracking-wider text-slate-500 px-3 pt-4 pb-1">Platform
                Core</div>

            <button onclick="switchSuperadminTab('settings')" id="super-nav-settings"
                class="super-nav-btn w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-slate-900 transition-all">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
