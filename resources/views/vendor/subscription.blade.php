    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-xs p-6">
                ...
                <div class="flex items-baseline gap-2">
                    <span
                        class="text-5xl font-extrabold text-slate-900 font-heading leading-none">{{ Auth::user()->vendorProfiles->assets ?? 0 }}</span>
                    <span class="text-slate-400 font-medium text-sm">/ {{ $maxAsset ?? 100 }}</span>
                </div>
                <div class="mt-4 w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
                    <div class="bg-indigo-500 h-full rounded-full" style="width: 48%"></div>
                </div>
                <div class="text-[11px] text-slate-400 mt-1.5 font-mono">Slot Kuota: {{ $maxAsset ?? 100 }}</div>
            </div>
        </div>
