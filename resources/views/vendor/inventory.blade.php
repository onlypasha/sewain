    ...
    <div id="tab-content-inventory" class="admin-tab-pane hidden space-y-6">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-slate-500 text-xs mt-0.5">Kelola seluruh item sewa, ketersediaan stok, dan tarif harian toko
                    Anda.</p>
            </div>

            <div class="flex items-center gap-3">
                <button onclick="openAddAssetModal()"
                    class="btn btn-emerald btn-primary btn-sm font-bold text-white shadow-md">
                    + Tambah Item Baru
                </button>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex items-center gap-1 overflow-x-auto max-w-full pb-1 sm:pb-0">
                ...
                <button class="px-3 py-1.5 rounded-lg text-xs font-medium text-slate-600 hover:bg-slate-100">Kamera & Body
                    (18)</button>
                <button class="px-3 py-1.5 rounded-lg text-xs font-medium text-slate-600 hover:bg-slate-100">Lensa Cinema
                    (16)</button>
                <button class="px-3 py-1.5 rounded-lg text-xs font-medium text-slate-600 hover:bg-slate-100">Lighting & Rig
                    (14)</button>
            </div>

            <!-- Quick Table Search -->
            <div class="w-full sm:w-64">
                <input type="text" placeholder="Filter nama barang..."
                    class="w-full px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-xs focus:outline-none focus:border-emerald-600">
            </div>
        </div>
                ...
                <table class="table w-full text-xs">
                    ...
                    <tbody class="divide-y divide-slate-100 font-medium">
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            ...
                            <td class="text-center font-mono font-bold">5 / <span class="text-emerald-600">3 Ready</span>
                            </td>
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            ...
                            <td class="text-center font-mono font-bold">4 / <span class="text-emerald-600">4 Ready</span>
                            </td>
                            <td class="font-bold text-slate-900">Rp 250.000</td>
                            <td class="text-amber-700 font-semibold">Rp 250.000</td>
                            <td class="text-center">
                                <span
                                    class="badge badge-sm badge-emerald text-emerald-800 bg-emerald-100 font-semibold">Ready
                                    Stok</span>
                            </td>
                            <td class="text-right">
                                <div class="flex items-center justify-end gap-1">
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            ...
                            <td class="text-center font-mono font-bold">6 / <span class="text-amber-600">1 Buffer</span>
                            </td>
