...
<head>
    ...
    <meta name="description"
        content="Halaman masuk resmi pemilik bisnis rental Sewain Multi-Tenant OS. Kelola stok aset, kalender sewa, dan laporan keuangan dalam satu dashboard.">
...
<body
    class="bg-hero-light min-h-screen text-slate-800 antialiased selection:bg-emerald-500 selection:text-white flex flex-col justify-between">
    ...
    <main class="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-10">
        <div
            class="w-full max-w-xl lg:grid-cols-12 bg-white rounded-3xl shadow-2xl border border-slate-200/90 overflow-hidden">
            {{-- <x-login.showcase /> --}}
            <x-login.form />
        </div>
    </main>
