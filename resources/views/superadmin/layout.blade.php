...
<head>
    ...
    <meta name="description"
        content="Konsol kontrol utama Superadmin Platform Sewain. Kelola 1,400+ tenant, MRR billing, dan infrastruktur server.">
...
<body
    class="bg-slate-50 text-slate-800 antialiased selection:bg-indigo-500 selection:text-white flex h-screen overflow-hidden">
